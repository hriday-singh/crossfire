 ...
 * - Blueprint HUD callouts, dimension calipers, technical grid coordinates, and CAD leader lines
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ================= BACKGROUND CAD BLUEPRINT HUD & MEASUREMENT AXES ================= */}
        <g opacity="0.65" className="font-mono text-[9px]">
          {/* Horizontal Center Datum Line */}
          <line x1="20" y1="130" x2="520" y2="130" stroke="#0284c7" strokeWidth="0.75" strokeDasharray="6 4 2 4" />
          
          {/* Dimension Caliper Top */}
