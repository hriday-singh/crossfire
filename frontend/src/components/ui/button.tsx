...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 select-none",
  {
    variants: {
      variant: {
        default:
          "bg-white text-zinc-950 shadow-sm hover:bg-zinc-200 font-medium",
        destructive:
          "bg-rose-950/40 text-rose-300 border border-rose-800/60 shadow-sm hover:bg-rose-900/60",
        outline:
          "border border-zinc-800 bg-transparent text-zinc-200 shadow-sm hover:bg-zinc-900 hover:text-zinc-100",
        secondary:
