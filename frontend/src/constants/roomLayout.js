...
export const CUBICLE_LAYOUTS = [
  {
    ...
    name: "Cubicle 01 // DEVIL'S ADVOCATE",
...
export const WAYPOINTS = {
  // Cubicle 1: Devil's Advocate (NW)
  cubicle_1_desk: {
    id: 'cubicle_1_desk',
    name: "Cubicle 01 Desk (Devil's Advocate)",
    x: 321,
    y: 156,
    facing: 'south',
    isChair: true,
  ...
  cubicle_1_stand: {
    id: 'cubicle_1_stand',
    name: "Cubicle 01 Pinboard Stand",
    x: 352,
    y: 195,
    facing: 'south',
    isChair: false,
  ...
  // Cubicle 2: Receipts (SW)
  cubicle_2_desk: {
    id: 'cubicle_2_desk',
    name: 'Cubicle 02 Desk (Receipts)',
    x: 310,
    y: 425,
    facing: 'north',
    isChair: true,
  ...
  cubicle_2_stand: {
    id: 'cubicle_2_stand',
    name: 'Cubicle 02 Citations Stand',
    x: 352,
    y: 385,
    facing: 'south',
    isChair: false,
  ...
  // Cubicle 3: Builder (NE)
  cubicle_3_desk: {
    id: 'cubicle_3_desk',
    name: 'Cubicle 03 Desk (Builder)',
    x: 679,
    y: 156,
    facing: 'south',
    isChair: true,
  ...
  cubicle_3_stand: {
    id: 'cubicle_3_stand',
    name: 'Cubicle 03 Architecture Stand',
    x: 648,
    y: 195,
    facing: 'south',
    isChair: false,
