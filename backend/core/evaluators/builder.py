...
BUILDER_SYSTEM_PROMPT = (
    ...
    "- Do NOT evaluate statutory legal compliance, regulatory penalties, or industry mandates (the Researcher verifies external laws with citations).\n"
    "- Do NOT evaluate corporate procurement cycles, human change resistance, or bureaucratic politics (the Operator handles operational friction).\n"
    "- Do NOT challenge abstract logical deductions or user motivation (Devil's Advocate evaluates deductive premises).\n"
    "Focus purely on Technical Execution & Mechanics: software architecture, infrastructure requirements, data pipelines, API rate limits/access, latency, compute, state synchronization, and concrete Day-1 technical blockers.\n\n"
