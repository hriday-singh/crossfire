...
Cross-reference for `docs/02-dev-A-core-loop-providers.md`, `docs/03-dev-B-evidence-researcher.md`, `docs/04-dev-C-api-sse-evaluators.md`. Two states only, per checklist section:
...
## Dev B — [`dev-b/`](dev-b/README.md) (spec still at `03-dev-B-evidence-researcher.md`)
...
**ANTIGRAVITY:** all of it, in order — `evidence/search.py`, `evidence/curate.py`, `core/evaluators/researcher.py`, `evidence/fetch.py`, adaptive-scrutiny branch, demo fallback switch, failure handling, stretch `ingestion/pdf.py`.
